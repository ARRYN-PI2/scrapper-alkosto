...
from .adapters.alkosto_hybrid_adapter import AlkostoHybridAdapter
...
def main():
    ...
    s.add_argument("--hybrid", action="store_true", help="Usar adaptador híbrido (Algolia + detalles HTML)")
    ...
    if args.cmd == "scrape":
        ...
        if args.hybrid:
            scraper = AlkostoHybridAdapter()
            print("🔄 Usando adaptador híbrido (Algolia + detalles HTML)")
        elif args.legacy:
